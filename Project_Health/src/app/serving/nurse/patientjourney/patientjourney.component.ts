...
import { IToken, ITokenAndRooms, ITokenJourney } from '../../_model/tokenmodel';
...
@Component({
  selector: 'app-patientjourney',
  templateUrl: './patientjourney.component.html',
  styleUrls: ['./patientjourney.component.scss']
})
export class PatientjourneyComponent implements OnInit {
  ...
  private router: Router) {
      ...
      this.loading = true;
      this.tokenService.getTokenTraverse(this.tokenData.reportId).subscribe((response: ITokenJourney[]) => {
