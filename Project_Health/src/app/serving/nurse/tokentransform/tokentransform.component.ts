...
import {
  ActionType,
  AlertMessageService
} from "../../../_services/alertMessageService";
...
@Component({
  selector: "app-tokentransform",
  templateUrl: "./tokentransform.component.html",
  styleUrls: ["./tokentransform.component.scss"]
})
export class TokentransformComponent implements OnInit {
  transferForm: FormGroup;
  loading: boolean = false;
  servicesList: IServiceData[] = [];
  doctorsList: IDoctorData[] = [];

  constructor(private dialogRef: MatDialogRef<TokentransformComponent>,
    private fb: FormBuilder,
    @Inject(MAT_DIALOG_DATA) public tokenData: IServingTokens,
