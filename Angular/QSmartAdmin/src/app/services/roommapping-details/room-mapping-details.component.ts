...
@Component({
  ...
  <mat-card-header>
    <div fxLayout="row wrap" style="margin-top:5px;">
      <h4>{{ 'serviceModule.roomMappingDetails.assignRooms' | translate }}</h4>
    </div>
...
<div fxFlex>
  <div class="bord-all pad-all-sm" style="background: #fafafa"> <strong>{{ 'serviceModule.roomMappingDetails.roomType' | translate }}</strong> </div>
  <div class="bord-all pad-all-sm"> {{key}}</div>
</div>


<div fxFlex>
  <div class="bord-all pad-all-sm" style="background: #fafafa"> <strong>{{ 'serviceModule.roomMappingDetails.roomNumber' | translate }}</strong> </div>
