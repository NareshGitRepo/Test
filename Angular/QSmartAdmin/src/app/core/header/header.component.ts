...
export class HeaderComponent implements OnInit {
  ...
  ngOnInit() {
    if (this.notifyFlag) {
      console.log('this.notifyFlag',this.notifyFlag)
  ...
  getNotifications() {
    ...
    this.notificationService.getNotifications().subscribe(
      (result: INotification[]) => {  console.log('result notification',result)
        if (result.length > 0) {
          this.notificationList = result;  console.log('this.notificationList::',this.notificationList, 'notificationStatus::',this.notificationStatus)
  ...
  notificationAction() {
    console.log('notificationStatus',this.notificationStatus)
