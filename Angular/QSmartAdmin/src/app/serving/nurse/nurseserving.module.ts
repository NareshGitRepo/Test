...
import { FormatTimePipe, FormatTimePipeWithSec } from '../_pipe/filterpipe';
...
@NgModule({
  ...
  declarations: [ NursemanageComponent,FormatTimePipe,FormatTimePipeWithSec,NursetokenviewComponent, TokentimeviewComponent,NurseAlertComponent,  ServingtokenviewComponent, TokentransformComponent, PatientjourneyComponent],
  entryComponents: [NursetokenviewComponent,TokentimeviewComponent,NurseAlertComponent,ServingtokenviewComponent, TokentransformComponent,PatientjourneyComponent],
  providers: []
})
