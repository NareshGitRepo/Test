import { Floor, IClients, ICreateDepartments, ICreateUsers, IDepartements, IDoctorList, IGetUser, IGroups, IHospitals, IMDepartment, IMapNurse, IResActiveUser, IRoles, IRoomManagementList, IUser, IUserResponse } from '../_model/IUsers';
