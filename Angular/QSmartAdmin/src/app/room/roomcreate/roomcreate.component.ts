...
import { FormArray, Validators, FormBuilder, FormGroup, AbstractControl, ValidationErrors, AsyncValidatorFn } from '@angular/forms';
import { MatDialogRef } from '@angular/material';

import { TranslateService } from '@ngx-translate/core';
import { IRoom, ICreateRoom, Room, RoomList, IRoomResponse, Level, RoomType, IRoomsList } from '../_model/roomModel';
...
export class RoomcreateComponent implements OnInit {
  ...
  createData(rmTypeId, roomnumber?, roomname?, arabicname?) {
    const roomObj = this.fb.group({
      ...
      allowedToAccess:[1,[Validators.required,Validators.max(5), Validators.min(1)]],
      rmTypeId: [rmTypeId]
    })
