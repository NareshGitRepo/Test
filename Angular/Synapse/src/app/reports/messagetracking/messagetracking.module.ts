...
import { MessageTrackingReportRoutes } from './messagetracking.router';
import { MessagetrackingComponent } from './manage/messagetracking.component';
import { MaterialModule } from '../../_shared/material.module';
import { MessageLimitPipe } from './_model/messagetracking';
...
@NgModule({
  imports: [
    ...
    FileUploadModule,
    TruncateModule,
    RouterModule.forChild(MessageTrackingReportRoutes),
...
export class MessageTrackingReportModule { }
